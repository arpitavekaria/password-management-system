...
import AddCredentialType from "@/components/admin/credential-type/AddCredentialType";
import {deleteCredentialType, getCredentialTypes} from "@/server/credential-type";
import {ApiResponseType} from "@/lib/utiills/enums/ApiResponseType";
import {toast} from "sonner";
import EditCredentialType from "@/components/admin/credential-type/EditCredentialType";
...
const CredentialType = () => {
    ...
    const handleRowSelectionChange = (rows: CredentialType[]) => {
    ...
    const loadData = async () => {
        ...
        setLoading(true);
        const fetchedData = await getCredentialTypes(formData);
        if (fetchedData) {
            setLoading(false);
    ...
    const handleDelete = async () => {
        const fetchedData = await deleteCredentialType(dataId);
    ...
    const columns: ColumnDef<CredentialType, unknown>[] = [
        {
            accessorKey: "id",
            header: "ID",
            id: "id",
            ...
            <div className="col-span-12">
                <div className="flex flex-row items-center justify-between">
                    <div className="flex flex-col">
                        ...
                        <span className="font-semibold text-lg mb-0">CredentialType</span>
                    </div>
                </div>
            </div>
            <div className="col-span-12 mt-6">
                <Card className='rounded-sm border-0'>
                    ...
                    <CardContent className="p-0">
                        <DataTable<CredentialType, unknown>
                            columns={columns}
                            data={data}
                ...
                <Dialog open={isOpenModal} onOpenChange={setIsOpenModal}>
                    <DialogContent className="xl:max-w-3xl sm:max-w-sm">
                        <DialogHeader>
                            <DialogTitle>Add Credential Type</DialogTitle>
                        </DialogHeader>
                        <AddCredentialType closeModal={closeModal} loadData={loadData}/>
                    </DialogContent>
                </Dialog>
                ...
                <Dialog open={isEditOpenModal} onOpenChange={setIsEditOpenModal}>
                    <DialogContent className="xl:max-w-3xl sm:max-w-sm">
                        <DialogHeader>
                            <DialogTitle>Edit Credential Type</DialogTitle>
                        </DialogHeader>
                        <EditCredentialType closeModal={closeEditModal} loadData={loadData} dataId={dataId}/>
                    </DialogContent>
                </Dialog>
            </div>
