...
import {addCredentialType} from "@/server/credential-type";

const AddCredentialType = (props: any) => {
    const {closeModal,loadData} = props

    const setIsLoading = useCommonStore((state:any) => state.setIsLoading);
    const [state, dispatch, isPending] = useActionState(addCredentialType, undefined);
