...
import {deleteProject, getProjects} from "@/server/project";
...
const Project = () => {
    ...
    const handleRowSelectionChange = (rows: Project[]) => {
    ...
    const loadData = async () => {
        ...
        setLoading(true);
        const fetchedData = await getProjects(formData);
        if (fetchedData) {
    ...
    const handleDelete = async () => {
        const fetchedData = await deleteProject(dataId);
            ...
            <div className="col-span-12">
                <div className="flex flex-row items-center justify-between">
                    <div className="flex flex-col">
                        ...
                        <span className="font-semibold text-lg mb-0">Project</span>
                    </div>
                </div>
            </div>
            <div className="col-span-12 mt-6">
                ...
                <Dialog open={isOpenModal} onOpenChange={setIsOpenModal}>
                    <DialogContent className="xl:max-w-3xl sm:max-w-sm">
                        ...
                        <AddProject closeModal={closeModal} loadData={loadData}/>
                    </DialogContent>
                </Dialog>
                ...
                <Dialog open={isEditOpenModal} onOpenChange={setIsEditOpenModal}>
                    <DialogContent className="xl:max-w-3xl sm:max-w-sm">
                        ...
                        <EditProject closeModal={closeEditModal} loadData={loadData} dataId={dataId}/>
                    </DialogContent>
                </Dialog>
            </div>
