...
import {deleteClient, getClients} from "@/server/client";
...
const Client = () => {
    ...
    const loadData = async () => {
        ...
        setLoading(true);
        const fetchedData = await getClients(formData);
        if (fetchedData) {
            setLoading(false);
    ...
    const handleDelete = async () => {
        const fetchedData = await deleteClient(dataId);
            ...
            <div className="col-span-12">
                <div className="flex flex-row items-center justify-between">
                    <div className="flex flex-col">
                        ...
                        <span className="font-semibold text-lg mb-0">Client</span>
                    </div>
                </div>
            </div>
            <div className="col-span-12 mt-6">
                ...
                <Dialog open={isOpenModal} onOpenChange={setIsOpenModal}>
                    <DialogContent className="xl:max-w-3xl sm:max-w-sm">
                        ...
                        <AddClient closeModal={closeModal} loadData={loadData}/>
                    </DialogContent>
                </Dialog>
                ...
                <Dialog open={isEditOpenModal} onOpenChange={setIsEditOpenModal}>
                    <DialogContent className="xl:max-w-3xl sm:max-w-sm">
                        ...
                        <EditClient closeModal={closeEditModal} loadData={loadData} dataId={dataId}/>
                    </DialogContent>
                </Dialog>
            </div>
