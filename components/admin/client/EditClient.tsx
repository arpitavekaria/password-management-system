...
import {editClient, getClientById} from "@/server/client";
...
const EditClient = (props: any) => {
    ...
    const [state, dispatch, isPending] = useActionState(editClient, undefined);

    useEffect(() => {
        setIsLoading(true);
        const fetchData = async () => {
            try {
                const result = await getClientById(dataId);
